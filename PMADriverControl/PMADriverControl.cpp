...
// PMADriverControl.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPMADriverControlApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CPMADriverControlApp

CPMADriverControlApp::CPMADriverControlApp()
{
...
// Единственный объект CPMADriverControlApp

CPMADriverControlApp theApp;


// Инициализация CPMADriverControlApp

BOOL CPMADriverControlApp::InitInstance()
{
