...
// Target_MFC_Application.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTargetMFCApplicationApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTargetMFCApplicationApp

CTargetMFCApplicationApp::CTargetMFCApplicationApp()
{
...
// Единственный объект CTargetMFCApplicationApp

CTargetMFCApplicationApp theApp;


// Инициализация CTargetMFCApplicationApp

BOOL CTargetMFCApplicationApp::InitInstance()
{
